...
4. "about" — if the user is asking about the chatbot, what it can do, what is Postcard Travel, or how you can help.
...
- "What is Postcard Travel?" → about
- "How can you help me plan my trip?" → about
-"What can you do?" → about
- "how does this work", "what services you provide", "explain postcard" → about

### Query:
{user_query}
Output only the classification value: greeting, hotel_followup, normal or about.
Do not explain.
...
"""
    ...
    if classification not in ["greeting", "hotel_followup", "normal", "about"]:
