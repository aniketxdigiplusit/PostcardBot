...
# LLM Configuration
llm = ChatOllama(model="llama3.1:8b", temperature=0.7, base_url="http://192.168.1.24:11434")
sllm = ChatOllama(model="gemma2:2b", temperature=0.7, base_url="http://192.168.1.24:11434")
OLLAMA_API_URL = os.getenv("OLLAMA_API_URL", "http://192.168.1.24:11434")
